...
namespace CarParkingManagementSystem
{
    ...
    public static class DataManager
    {
        ...
        {
            new User { Username = "admin", Password = "pass123", FullName = "Admin User", Role = UserRole.Admin },
            new User { Username = "attendant1", Password = "pass123", FullName = "John Smith", Role = UserRole.Attendant }
        };
